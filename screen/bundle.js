...
/***/ function(module, exports, __webpack_require__) {
	...
	$("#inputer").on("input",function(e){
	 if($(this).data("lastval")!= $(this).val()){
		 	 var $this = $(this);
	     $this.data("lastval", $this.val());
	     //change action
			 var ob = highlight($this.val());
	     $('#sentence').html($this.val());
			 if (ob.location) {
				$("#sentence").html($('#sentence').html().replace(new RegExp(ob.location + '(?![\\s\\S]*' + ob.location + ')'), '<code class="location">$&</code>'))
			 }
			 if (ob.startDate_regex) {
				$("#sentence").html($('#sentence').html().replace(ob.startDate_regex, '<code class="date">' + ob.startDate_regex + '</code>'));
			 }
			 if (ob.endDate_regex) {
				$("#sentence").html($('#sentence').html().replace(ob.endDate_regex, '<code class="date">' + ob.endDate_regex + '</code>'));
			 }
			 if (ob.startTime_regex) {
				$("#sentence").html($('#sentence').html().replace(ob.startTime_regex, '<code class="time">' + ob.startTime_regex + '</code>'));
			 }
			 if (ob.endTime_regex) {
				$("#sentence").html($('#sentence').html().replace(ob.endTime_regex, '<code class="time">' + ob.endTime_regex + '</code>'));
			 }
			 $("#sentence").html($('#sentence').html().replace(repeat_action_reg, '<code class="repeat">$&</code>'));
	 };
	});
	...
	*/
	...
	//******************************************************************************
	  ...
	  var __sp = S.prototype = {
	    ...
	    count: function(ss) {
	      return __webpack_require__(105)(this.s, ss)
	    },
	    ...
	    splitLeft: function(sep, maxSplit, limit) {
	      return __webpack_require__(106)(this.s, sep, maxSplit, limit)
	    },

	    splitRight: function(sep, maxSplit, limit) {
	      return __webpack_require__(107)(this.s, sep, maxSplit, limit)
	    },
