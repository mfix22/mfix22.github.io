...
/***/ function(module, exports, __webpack_require__) {
	...
	// local modules
	var PROJECTS = __webpack_require__(170);
	var MiloCard = __webpack_require__(171);

	for (var i in PROJECTS) {
	  var p = PROJECTS[i];
	  ReactDOM.render(React.createElement(MiloCard, { desc: p.desc, link: p.link, img: p.img, header: p.header }), document.getElementById(p.id));
	}
...
/***/ function(module, exports) {
	...
	module.exports = [{
	  ...
	  'id': 'automaton',
	  'desc': 'Advertising that drives itself',
	  'img': 'automaton.png',
