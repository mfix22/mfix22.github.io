...
function Home() {
  ...
  return __jsx(Terminal, {
    ...
    __self: this
  }, "Music by Dessa, Kendrick Lamar, Jackson Browne, Vince Staples & The Roots"), __jsx(LI, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74
    },
    ...
    __self: this
  }, "Designsystems.com \u2014 White-labeling: Putting the design system in users' hands")), _components_writings_json__WEBPACK_IMPORTED_MODULE_4__.items.map(function (item) {
    return __jsx(LI, {
      key: item.guid,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.c796407db20e578b4bd5.hot-update.js.map